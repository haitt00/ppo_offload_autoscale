...
class OffloadAutoscaleEnv(gym.Env):
    ...
    def render(self):
        ...
        print('{:7.2f} {:7.2f} {:7.2f} {:7.2f} {:4} {} {:8.2f} {:7.2f} {:5.2f} {:5.0f}'.format(self.g,self.d_op, self.d_com,self.d,self.m,self.mu, self.state[0],self.state[1],self.state[2],self.state[3]))
